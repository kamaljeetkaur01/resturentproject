...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Shakes</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<h1 style="font-size:25px;"><u>Shakes</u></h1><br>
	   		Roohafza Shake<br>
	   		Banana Shake  <br>
	   		Mango Shake <br>
	   		Mixed fruit Shake 
	   		<h1 style="font-size:25px;"><u>Ice Cream Shakes</u></h1>
	   		Strawberry Shake<br>
	   		 Vanilla Shake<br>
	   		 Chocolate Shake <br>
	   		 Butter Scotch Shake
	   		 <h1 style="font-size:25px;"><u>Fruit Crush Shakes </u></h1>
	   		Orange Crush Shake<br>
	   		 Mango Crush Shake <br>
	   		 Strawberry	Crush Shake <br>
	   		 Banana Crush Shake<br>
	   		 Kiwi Crush Shake <br>
	   		 Black Current Crush Shake <br><br>
	   	</div>
	   	...
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br><br><br><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">60</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">60</i><br>
	   	...
	   	<div class="col-md-5"><img src="shakes.png" style="margin-top:68px;height:379px;"></div>
	   </div>
	   </div>
	</div>
</body>
