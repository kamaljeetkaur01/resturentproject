...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;margin-left:-64px;">Breakfast</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br>
	   		<h1 style="font-size:25px;"><u>Paratha</u></h1>
          <span style="font-size:17px;">Aloo-paratha</span><br>
          <span style="font-size:17px;">Methi-Thepla</span><br>
          <span style="font-size:17px;">Gobhi_paratha</span><br>
          <span style="font-size:17px;">Cheese-paratha</span><br>
          <span style="font-size:17px;">Tomato Omelette</span>
        <h1 style="font-size:25px;"><u>Other Items</u></h1>
         <span style="font-size:17px;">Poha</span><br>
         <span style="font-size:17px;">Bread jam</span><br>
         <span style="font-size:17px;">Idli-Sambhar</span><br>
         <span style="font-size:17px;">Upma</span><br>
         <span style="font-size:17px;">Bread</span><br>
         <span style="font-size:17px;">Cheese toast</span><br>
         <span style="font-size:17px;">Sandwich</span>
      ...
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">40</i><br><br><br><br><br>
      ...
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">50</i><br>
	   	...
	   	<div class="col-md-5"><img src="breakfast.jpg" style="margin-top:80px;height:265px;width:277px;border-radius: 131px;"></div>
	   </div>
	   </div>
	</div>
</body>
