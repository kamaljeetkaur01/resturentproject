...
<body>
 ...
 <div class="nav">
         ...
         <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"  style="text-decoration:none;">EVENTS<span class="caret"></span></a>
          ...
          <li><a href="event2.html">New Year Party</a></li>
            ...
            <li><a href="shakes.html">Shakes</a></li>
               ...
               <li><a href="gallary.html" style="text-decoration:none;">GALLERY</a></li>
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Ice Cream</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br><br><br><br>
	   		<span style="font-size:17px;">Vanilla </span> <br>      
	   		<span style="font-size:17px;">Strawberry </span>    <br>
	   		<span style="font-size:17px;">Chocolate</span>  <br>
	   		<span style="font-size:17px;">Butter scotch </span> 
	   		<h1 style="font-size:25px;"><u>Tutti Fruity</u></h1>
	       <span style="font-size:17px;"> Small</span><br>
	        <span style="font-size:17px;">Large</span>
	   		</div>
	   	<div class="col-md-3" >
	   	<br><br><br><br>
	   	...
	   	<div class="col-md-5"><img src="ice.png" style="margin-top:41px;height: 296px;"></div>
	   </div>
	   </div>
	</div>
</body>
