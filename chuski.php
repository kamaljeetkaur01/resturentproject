...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Chuski</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br><br><br><br>
	   		 <span style="font-size:17px;">Rose Chuski</span> <br>
	   		 <span style="font-size:17px;">Orange Chuski</span> <br>
	   		 <span style="font-size:17px;">Lemon Chuski  </span>    <br>
	   	   <span style="font-size:17px;"> Khus Chuski</span>
	   	...
	   	<div class="col-md-5"><img src="chski.png" style="margin-top:32px;"></div>
	   </div>
	   </div>
	</div>
</body>
