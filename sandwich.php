...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Sandwich</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		...
	   		Corn Sandwich  <br>
	   		Veg Cheese Sandwich
	   		<h1 style="font-size:25px;">Grilled</h1>
	   		Grilled Veg Sandwich <br>
	   		Grilled Corn Sandwich   <br>
	   		Grilled Veg Tikki Sandwich<br>
	   		Grilled Paneer Sandwich<br><br>
	   		 <br><br>
	   	...
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">120</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">150</i><br>
	   	
	   	</div>
	   	<div class="col-md-5"><img src="sandwich.png" style="margin-top:9px;"></div>
	   </div>
	   </div>
	</div>
</body>
