...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;text-align:center;">Lunch</h1>
	   </div>
	   <div class="container">
      ...
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
        <i class="fa fa-inr" style="font-size:18;margin-left:30px;">70</i><br>
	   	...
	   	<div class="col-md-5"><img src="lunch.jpg" style="margin-top:15px;height:265px;width:277px;border-radius: 131px;"></div>
	   </div>
	   </div>
	</div>
</body>
