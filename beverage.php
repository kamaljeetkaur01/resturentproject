...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Beverage</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br>
	   		<span style="font-size:17px;">Hot Tea</span><br>
	   		<span style="font-size:17px;">Khatta Meetha Pani</span><br>
	   		<span style="font-size:17px;">Milk Tea</span><br>
	   		<span style="font-size:17px;">Hot Coffee</span><br>
	   		<span style="font-size:17px;">Milk Badam</span>  <br>
	   		<span style="font-size:17px;">Soup (Tomato/Mix Veg)</span> <br>
	   		 <span style="font-size:17px;">Ice Tea</span><br>
	   		 <span style="font-size:17px;">Cold Coffee</span><br>
	   		 <span style="font-size:17px;">Cold Coffee+ Ice Cream</span><br>
	   		 <span style="font-size:17px;">Citrus Cooler</span> 

	   		<h1 style="font-size:30px;"><u> Special Drink</u></h1>
<span style="font-size:17px;">Orange</span><br>
	   		<span style="font-size:17px;"> Mango</span>       <br>
	   		<span style="font-size:17px;"> Pineapple</span>    <br>
	   		 <span style="font-size:17px;">Strawberry</span><br>
	   		<span style="font-size:17px;"> Apple</span> <br>  
	   		<span style="font-size:17px;"> Kiwi</span> 
	   	</div>
	   	<div class="col-md-3" ><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">15</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">20</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">30</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">30</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">40</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">40</i><br>
	   	...
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br><br><br><br><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">90</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">90</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">100</i><br>
	   		
	   		
	   	</div>
	   	<div class="col-md-5"><img src="beverage.png" style="margin-top:68px;"></div>
	   </div>
	   </div>
	</div>
</body>
