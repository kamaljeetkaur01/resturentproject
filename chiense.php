...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Chinese </h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br><br><br>
	   		 <span style="font-size:15px;">Maggi Noodles</span><br>
	   		 <span style="font-size:15px;">Pasta</span> <br>
	   		 <span style="font-size:15px;">Steamed Momos (7pc)</span>   <br>
	   	     <span style="font-size:15px;">Fried Momos (7pc)</span><br>
	   	     <span style="font-size:15px;">Chowmein</span><br>
	   	     <span style="font-size:15px;">Spring Roll</span><br>
	   	    <span style="font-size:15px;"> Manchurian Dry </span><br>
	   	    <span style="font-size:15px;"> Manchurian Gravy </span>        
	   	</div>
	    ...
	    <i class="fa fa-inr" style="font-size:18;margin-left:30px;">70</i><br>
	   	...
	   	<div class="col-md-5"><img src="chiense.png" style="margin-top:15px;"></div>
	   </div>
	   </div>
	</div>
</body>
