  ...
  .third
	{
		height: 800px;
		width: 100%;
    background-image: linear-gradient(rgba(255, 12, 0, 0.59),#009688,rgba(255, 87, 34, 0.94));
		position: absolute;
	}
    ...
    <!-- third cls start here-->
         <div class="third">
          ...
          <br>
           <div class="col-md-12">
               <div class="col-md-6" >
               	       <img src="newyear.jpg" style="height: 200px;width: 419px;margin-left:200px;border:solid black;"> <br> <br>
               	       <img src="reception.jpg" style="height: 200px;width: 419px;margin-left:200px;border:solid black;"><br><br> 
               	        <img src="party.jpg" style="height: 200px;width: 419px;margin-left:200px;border:solid black;"> 

               </div>
                   <div class="col-md-6" >
                     <div style="height: 200px;width: 547px;border: solid #FFC107;background:black;    margin-left: -15px;">
                         <h1 style="margin-top:17px;font-family:cursive;color:orange;text-align:center;">New Year  Party</h1>
                   	...
                   	<div style="height: 200px;width: 547px;border: solid #FFC107;background:black;    margin-left: -15px;">
                         <h1 style="margin-top:4px;font-family:cursive;color:orange;text-align:center;"> Party</h1>
