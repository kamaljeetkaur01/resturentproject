...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;text-align:center;">Dinner</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4">
	   	<br><br><br>
	   	<b style="font-size:">Thali</b><br>
	   	(Paneer Gravy + Rajmah + 1 Pc Soya Champ +Rice + Dahi 2 Pc Bread/Butter/ chapati)<br>
	   	 <b>Thali</b><br>
	   		(Paneer Gravy + Manchurian + Rajmah + <br> Rice + Dahi + Gulab Jamun 2pc Bread/Butter chapati) <br>
	   	Dal Makhni<br> 
      Chana<br>
      Macaroni<br>
      Mixed-salad<br>
      ...
      Roti   		
	   	...
	   	<div class="col-md-3" >
	   	<br><br><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">130</i><br><br><br>
    	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">150</i><br><br><br>
      ...
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">70</i><br>
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">40</i><br>
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">25</i><br>
      ...
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">10</i><br>
      <i class="fa fa-inr" style="font-size:18;margin-left:30px;">150</i>
    
	   	</div>
	   	<div class="col-md-5"><img src="Dinner.jpg" style="margin-top:80px;height:265px;width:277px;border-radius: 131px;"></div>
	   </div>
	   </div>
	</div>
</body>
