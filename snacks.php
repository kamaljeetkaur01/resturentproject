...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Snacks</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		...
	   		Hot Dog<br>
	   	    Stuffed<br>
	   	    (Stuffed with pineapple and chocolate) <br>
	   	    Veg Kathi Roll<br>
	   	    Paneer Kathi Roll
	   	    <h1 style="font-size:25px;">Soya Champ</h1>
            Small<br>
            Large
            <h1 style="font-size:25px;">French Fries</h1>
            Small<br>
            Large
            <h1 style="font-size:25px;">Smiley /Potato bites</h1>
            Small<br>
            Large
            <h1 style="font-size:25px;">Sweet Corn</h1>
            Small<br>
            Large<br><br>
            Jeera Fries   <br>
            Masala Fries  
	   	...
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">40</i><br><br>
	    ...
	    <i class="fa fa-inr" style="font-size:18;margin-left:30px;">80</i><br>
	   	...
	   	<div class="col-md-5"><img src="snacks.png" style="margin-top:79px;"></div>
	   </div>
	   </div>
	</div>
</body>
