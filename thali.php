...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Thali</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4">
	   
	   	<h1 style="font-size:25px;">Deluxe Thal</h1>
	   	(Paneer Gravy + Rajmah + 1 Pc Soya Champ +Rice + Dahi 2 Pc Bread/Butter/ chapati)<br>
	   	<h1 style="font-size:25px;">Executive Thali</h1>
	   		(Paneer Gravy + Manchurian + Rajmah + <br> Rice + Dahi + Gulab Jamun 2pc Bread/Butter chapati) <br><br>
         ...
         <br><br><br><br><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">200</i>
	   	</div>
	   	<div class="col-md-5"><img src="thali.png" style="margin-top:-10px;"></div>
	   </div>
	   </div>
	</div>
</body>
