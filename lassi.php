...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Lassi</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<br><br><br><br>
	   		<span style="font-size:17px;">Chaati Wali Lassi </span>  <br>
	   		<span style="font-size:17px;">Sweet Lassi</span><br>
	   		<span style="font-size:17px;">Salty Lassi </span><br>
	   	    <span style="font-size:17px;">Mango Lassi</span><br><br>
	   	...
	   	<div class="col-md-5"><img src="lassi.png" style="margin-top:8px;height:306px;"></div>
	   </div>
	   </div>
	</div>
</body>
