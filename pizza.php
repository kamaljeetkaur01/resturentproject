...
<body>
 ...
 <div class="nav">
	...
	<div class="top">
		<div class="txt">
		 <h1 style="font-size:70px;font-family:Algerian;">Pizza</h1>
	   </div>
	   <div class="container">
	   <div class="col-md-12" style="margin-top:136px;">
	   	<div class="col-md-4" >
	   		<h1 style="font-size:25px;">Single Topping</h1>
	   		Onion/Capsicum/Tomato <br>
	   		Cheese Pizza   <br><br>
	   		<h1 style="font-size:25px;">Double Toppings </h1>
	   		Onion - Capsicum<br>
	   		Onion - Tomato <br>
	   		 Tomato - Capsicum <br><br>
	   		 <h1 style="font-size:25px;">Four Seasons</h1>
	   		(Onion, Capsicum, Tomato & Corn)<br>
	   		 Paneer   <br>
	   		 Diamond Special Punjabi Pizza <br><br>
	   	...
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">100</i><br>
	   <br><br><br><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">140</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">160</i><br>
	   	<i class="fa fa-inr" style="font-size:18;margin-left:30px;">200</i><br>
	   	
	   	</div>
	   	<div class="col-md-5"><img src="pizza.png" style="margin-top:68px;"></div>
	   </div>
	   </div>
	</div>
</body>
